        ...
        <div className="relative flex w-11/12 max-w-4xl bg-white bg-opacity-10 border border-white/20 rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="flex-1 p-10 flex flex-col justify-center items-center text-center">
                ...
                <form className="w-80" action="/user/register" method="post">
                    ...
                    <input type="password" id="password" name="password" required placeholder="Create a password" className="w-full py-2 px-3 mb-4 border border-gray-300 rounded-full bg-white shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none transition duration-200"/>
    
                    <label htmlFor="balance" className="block text-sm text-gray-700 font-semibold text-left mb-1">Starting Balance:</label>
                    <input type="number" id="balance" name="balance" required placeholder="0" className="w-full py-2 px-3 mb-4 border border-gray-300 rounded-full bg-white shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none transition duration-200"/>
    
                    <button type="submit" className="w-full p-2 mt-6 bg-dark-blue text-white rounded-full hover:bg-hl-blue hover:text-dark-blue transition">Sign Up</button>
                </form>
